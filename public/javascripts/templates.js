...
templates['pub_name'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  return "\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.swap : depth0),{"name":"if","hash":{},"fn":this.program(1, data, 0),"inverse":this.program(3, data, 0),"data":data})) != null ? stack1 : "");
},"useData":true});
templates['table'] = template({"1":function(depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "<table class='table table-striped'>\n    <thead>\n        <th>"
    ...
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.icons1 : depth0),{"name":"each","hash":{},"fn":this.program(1, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "    </tbody>\n</table>";
